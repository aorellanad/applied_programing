 ...
 * @author DAVID
 */
public class FormularioCalificacion extends javax.swing.JFrame {

    /**
     * Creates new form FormularioCalificacion
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioCalificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioCalificacion().setVisible(true);
            }
        });
    }
